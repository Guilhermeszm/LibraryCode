...
function Linux.Create(config)
    ...
    local DialogOverlay = Linux.Instance("Frame", {
        Parent = LinuxUI,
    ...
    local function ShowConfirmationDialog()
        ...
        -- Position dialog relative to main frame
        ...
        ConfirmationDialog.Size = UDim2.new(0, 0, 0, 0)
        local tweenInfo = TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out)
        TweenService:Create(ConfirmationDialog, tweenInfo, {Size = UDim2.new(0, 280, 0, 140)}):Play()
    end
    
    local function HideConfirmationDialog()
        local tweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In)
        TweenService:Create(ConfirmationDialog, tweenInfo, {Size = UDim2.new(0, 0, 0, 0)}):Play()
        task.wait(0.2)
        DialogOverlay.Visible = false
        ConfirmationDialog.Visible = false
    end
    
    -- Update dialog position when main frame moves
