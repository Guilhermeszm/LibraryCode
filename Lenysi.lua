...
function Linux.Create(config)
    ...
    local TitleLine = Linux.Instance("Frame", {
        Parent = TopBar,
    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            ...
            -- Manter ícone sempre escuro, mesmo quando selecionado
            if TabIcon then
        ...
        TabBtn.MouseEnter:Connect(function()
            if CurrentTab ~= tabIndex then
                TweenService:Create(TabBtn, hoverTween, {BackgroundColor3 = Color3.fromRGB(30, 30, 35), BackgroundTransparency = 0}):Play()
                TweenService:Create(TabText, hoverTween, {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                -- Manter ícone escuro no hover
                if TabIcon then
                    TabIcon.ImageColor3 = Color3.fromRGB(150, 150, 150)
                end
            end
        ...
        TabBtn.MouseLeave:Connect(function()
            if CurrentTab ~= tabIndex then
                ...
                TweenService:Create(TabText, hoverTween, {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                -- Manter ícone escuro ao sair do hover
                if TabIcon then
                    TabIcon.ImageColor3 = Color3.fromRGB(150, 150, 150)
                end
            end
